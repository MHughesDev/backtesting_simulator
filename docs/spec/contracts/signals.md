# Contract Spec: Signals (the Exogenous-Signal Plane)

**Status:** ✅ Defined (architecture + binding + model integration). Per-vendor mapping detail is
...
[DATA_TAXONOMY.md](../DATA_TAXONOMY.md)).
...
[DATA_TAXONOMY.md](../DATA_TAXONOMY.md) §3) and must carry:
...
the [taxonomy](../DATA_TAXONOMY.md) categories 21–32 are *what kinds of real-world data map onto
