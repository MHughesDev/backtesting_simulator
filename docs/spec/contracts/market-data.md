...
[signals.md](signals.md) and [DATA_TAXONOMY.md](../DATA_TAXONOMY.md)). External information has a
...
[engines/engine-a-order-book.md](../engines/engine-a-order-book.md) §6.
...
fidelity, flagged in results). See [engines/engine-b-amm.md](../engines/engine-b-amm.md).
...
[run-request.md](../run-request.md) §4a.
...
5. **Reference data is queried, not replayed.** Payloads bound as `binding_type: "reference"`
   ...
   [run-request.md](../run-request.md) §4b.
