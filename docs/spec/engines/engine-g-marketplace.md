...
Marks arrive via `ComparableMarkEvent` (see [market-data.md](../contracts/market-data.md) §2.27).
...
and `MediaReference` payloads (see [signals.md](../contracts/signals.md)), governed by
