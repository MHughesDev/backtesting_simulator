...
State comes from `PoolState` payloads ([contracts/market-data.md](DATA-004-market-data-contract.md)
...
- **Gas:** per-swap gas cost from a `GasEvent` stream (see [contracts/market-data.md](DATA-004-market-data-contract.md) §2.19)
