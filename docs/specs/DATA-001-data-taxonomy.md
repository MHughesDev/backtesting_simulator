# Spec: DATA-001 — Data Taxonomy — The Complete Venue-Neutral Data Model

**Spec ID:** DATA-001
**Type:** Data (core type definitions)
**Status:** Approved
**Date:** 2026-06-06
**Author:** Agent
...
specified in [contracts/market-data.md](DATA-004-market-data-contract.md); this is the index.
...
These are governed by [run-request.md](DATA-002-run-request.md) §7 (output) and the validation sequence.
...
| Plane | Contract |
|---|---|
| Market-Data | [contracts/market-data.md](DATA-004-market-data-contract.md), [contracts/instrument.md](DATA-003-instrument-contract.md) |
| Exogenous-Signal | [contracts/signals.md](DATA-005-signals-contract.md) |
| Binding (both) | [run-request.md](DATA-002-run-request.md) §4 (market, instrument-keyed), §4b (reference), §4c (signals), §4d (cohorts) |
| Strategy/model use | [contracts/strategy.md](DATA-006-strategy-contract.md) §4 (cross-instrument refs), §6 (watch-vs-trade, scanner), §7–§8 |
| Multi-strategy composition | [contracts/plan.md](DATA-007-plan-contract.md) |
| Operational/output | [run-request.md](DATA-002-run-request.md) §7 |
