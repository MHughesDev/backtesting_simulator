...
listing marketplace engine — see [engine-g-marketplace.md](COMP-009-engine-g-marketplace.md)
...
[market-data.md](DATA-004-market-data-contract.md) §2.9 and §2.23 for full field definitions.
...
[engine-g-marketplace.md](COMP-009-engine-g-marketplace.md). NFT-specific behavior:
...
4. **NFT backtesting has fundamental limits.** Because liquidity is sparse and the buy price
   ...
   [engine-g-marketplace.md](COMP-009-engine-g-marketplace.md) §11.
